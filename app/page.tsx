      ...
      <main>
        ...
        <main className="max-w-350 mx-auto px-4 py-5">
          ...
          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Sillas - Bancas</h2>
            <ProdcutCarousel path='/productos/sillas/' data={silla} />
          </section>
          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Cajoneras</h2>
            <ProdcutCarousel path='/productos/cajoneras/' data={cajoneras} />
          </section>

          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Mesas - Comedores</h2>
            <ProdcutCarousel path='/productos/mesas/' data={mesas} />
          </section>

          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Roperos</h2>
            <ProdcutCarousel path='/productos/roperos/' data={roperos} />
          </section>

          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Centros de entretenimiento</h2>
            <ProdcutCarousel path='/productos/centro/' data={centro} />
          </section>

          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Sillones</h2>
            <ProdcutCarousel path='/productos/sillones/' data={sillones} />
          </section>

          <section className="mb-20">
            <h2 className="text-2xl mb-5 font-semibold text-primary">Otros Mubeles</h2>
